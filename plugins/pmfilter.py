...
async def next_page(bot, query):
    ...
    if settings.get('button'):
        ...
        btn.insert(0,
                   [
                       InlineKeyboardButton(
                           " #Request ", url=f"https://t.me/NotRk2xBot"),
                       InlineKeyboardButton(
...
async def advantage_spoll_choker(bot, query):
    ...
    if files:
        ...
        btn = InlineKeyboardMarkup(
            [[InlineKeyboardButton("🔰Cʟɪᴄᴋ ʜᴇʀᴇ & ʀᴇǫᴜᴇsᴛ ᴛᴏ ᴀᴅᴍɪɴ🔰", url="https://t.me/NotRk2xBot")]])
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        try:
            ...
            dreamcinezone = await query.edit_message_reply_markup(
                reply_markup=InlineKeyboardMarkup([
                    ...
                    [
                        InlineKeyboardButton('📌 Jᴏɪɴ Fɪʟᴇs Uᴘᴅᴀᴛᴇꜱ 📌', url=UPDATE_CHNL_LNK)
                    ]
                ])
            )
        ...
        buttons = [[
                    ...
                    InlineKeyboardButton(⚡ᴍᴏᴠɪᴇs/ᴡᴇʙ ʀᴇǫᴜᴇsᴛ✨', callback_data="https://t.me/Rk2x_Request"),
                ]]
    ...
    elif query.data == "Kuchh To hain":
        buttons = [[
            InlineKeyboardButton('Rᴋ2xBᴏᴛᴢ 📜', url='https://t.me/Rk2xBotz'),
            InlineKeyboardButton('⇋ ʙᴀᴄᴋ ⇋', callback_data='about')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
...
async def advantage_spell_chok(client, message):
    ...
    if not movies:
        ...
        button = [[InlineKeyboardButton(
            "🔍 Pᴀʜʟᴇ Gᴏɢɢʟᴇ Pᴀʀ Pᴛᴀ Kᴀʀ Sᴘᴇʟʟɪɴɢ Sᴀʜɪ Hᴀɪ 🔍", url=f"https://www.google.com/search?q={google}")]]
