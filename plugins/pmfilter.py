...
async def next_page(bot, query):
    ...
    if settings.get('button'):
        ...
        btn.insert(0,
                   [
                       InlineKeyboardButton(
                           "ᴊᴏɪɴ", url=f"https://t.me/Rk2xBotz"),
                       InlineKeyboardButton(
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        try:
            ...
            dreamcinezone = await query.edit_message_reply_markup(
                reply_markup=InlineKeyboardMarkup([
                    ...
                    [
                        InlineKeyboardButton('♻️ ᴍᴏᴠɪᴇs sᴇᴀʀᴄʜ ɢʀᴏᴜᴘ ♻️', url=GRP_LNK)
                    ]
                ])
            )
        ...
        buttons = [[
                    InlineKeyboardButton('🔰 ᗩᗪᗪ ᗰᗴ TO YOᑌᖇ ᘜᖇOᑌᑭ 🔰', url=f'http://telegram.me/{temp.U_NAME}?startgroup=true')
                ],[
                    InlineKeyboardButton(' 𝙷𝚎𝚕𝚙 📢', callback_data='help'),
                    InlineKeyboardButton(' ᗩᗷOᑌT 📖', callback_data='about')
                ],[
                    InlineKeyboardButton('⚡ Mᴏᴠɪᴇs ɢʀᴏᴜᴘ ⭐', callback_data="https://t.me/Rk2x_Request"),
                ]]
    ...
    elif query.data == "ᴋᴜᴄʜʜ ᴛᴏ ʜᴀɪ":
        buttons = [[
            InlineKeyboardButton('ᴊᴏɪɴ 📜', url='https://t.me/Rk2xBotz'),
            InlineKeyboardButton('⇋ ʙᴀᴄᴋ ⇋', callback_data='about')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
